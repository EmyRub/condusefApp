...
export default function LoginPage() {
    return (
        <>
            <main className="bg-[url('/public/bg1.jpg')] h-screen w-full flex justify-center items-center p-4 relative overflow-hidden">
                ...
                <form className="w-2/4 max-w-2xl mx-auto p-8 bg-gradient-to-t from-cyan-500 to-slate-800 rounded-xl shadow-lg opacity-90">
                    <img src="../public/logoGrudis.gif" alt="Logo Grudis" className="w-1/4 mx-auto" />
                    ...
                    <div className="mt-8 flex justify-between items-center">
                        ...
                        <img src="../public/logo-micro.png" alt="Logo Microfinix" className="w-52" />

                        <img src="../public/logo-condusef.png" alt="Logo Condusef" className="max-w-36" />
